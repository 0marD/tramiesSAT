...
export function EstadoCargando({ mensaje = 'Cargando...' }: EstadoCargandoProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 gap-4" role="status" aria-live="polite">
      <div className="w-8 h-8 border-4 border-slate-200 border-t-marca-accion rounded-full animate-spin" aria-hidden="true" />
...
export function SkeletonCard() {
  return (
    <div className="animate-pulse flex items-center gap-4 p-4 rounded-card bg-white border border-slate-200">
